        ...
        for(prop in propertyList){
            prop.apply {
                propertyString += when(type){
                    ...
                    NotionApiPropertyEnum.SELECT -> NotionApiPostPageObj.propertySelect(name, contents[0], optional!![0])
                    NotionApiPropertyEnum.MULTI_SELECT -> NotionApiPostPageObj.propertyMultiSelect(name, contents, optional!!)
